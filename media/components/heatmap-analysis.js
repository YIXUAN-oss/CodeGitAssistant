 ...
 * 根据提交数量获取颜色
 */
const getColorForCommits = (commits, maxCommits) => {
...
export class HeatmapAnalysisComponent {
    ...
    renderFileHeatmap() {
        var _a;
        const svg = this.container.querySelector('#file-heatmap');
        if (!svg)
            return;
        const fileStats = (_a = this.data) === null || _a === void 0 ? void 0 : _a.fileStats;
        if (!fileStats || (Array.isArray(fileStats) ? fileStats.length === 0 : fileStats.size === 0)) {
            const theme = getThemeColors();
            const container = svg.parentElement;
            const width = (container === null || container === void 0 ? void 0 : container.clientWidth) ? Math.max(container.clientWidth - 60, 800) : 800;
            const height = 400;
    ...
    renderContributorHeatmap() {
        var _a;
        const container = this.container.querySelector('#contributor-heatmap');
        if (!container)
            return;
        const contributorStats = (_a = this.data) === null || _a === void 0 ? void 0 : _a.contributorStats;
    ...
    drawContributorHeatmap(container, contributorStats) {
        container.innerHTML = '';
        const theme = getThemeColors();
        // 转换数据
