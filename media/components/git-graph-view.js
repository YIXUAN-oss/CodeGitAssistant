    ...
    render(data) {
        ...
        try {
            ...
            if (this.expandedCommit && this.containerRef) {
                const anchorRow = this.container.querySelector(`tr[data-commit-hash="${this.expandedCommit}"]`);
                if (anchorRow) {
            ...
            if (this.scrollAnchor && this.expandedCommit === this.scrollAnchor.hash && this.containerRef) {
                // 如果有滚动锚点，并且是针对当前展开的行
                const anchorRow = this.container.querySelector(`tr[data-commit-hash="${this.scrollAnchor.hash}"]`);
                if (anchorRow) {
