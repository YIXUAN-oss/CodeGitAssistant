...
const getGlobalState = () => {
    ...
    return {
        ...
        customEmojiShortcodeMapping: null
    };
};
 ...
 */
export function isUrlElem(elem) {
 ...
 */
export function isExternalUrlElem(elem) {
 ...
 */
export function isInternalUrlElem(elem) {
